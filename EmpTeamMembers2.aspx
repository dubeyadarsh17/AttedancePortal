<%@ Page Title="" Language="C#" MasterPageFile="~/dashboard.Master" AutoEventWireup="true" CodeBehind="EmpTeamMembers2.aspx.cs" Inherits="AttedancePortal.EmpTeamMembers2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div  style="margin-left:65px" >
        <asp:DataList ID="Empcards" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" CssClass="col-md-12"   >
            <ItemTemplate>
                <div class="col-lg-12 col-md-12 col-sm-12 " >
                    <div class="card my-3 mx-2 " >
                        <div class="card-body" >
                             <div class="d-flex flex-column details">
                            <div class="my-2 align-items-center text-center d-flex ">
