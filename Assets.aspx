<%@ Page Title="" Language="C#" MasterPageFile="~/dashboard.Master" AutoEventWireup="true" CodeBehind="Assets.aspx.cs" Inherits="AttedancePortal.WebForm3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

     <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.1/jquery.min.js" integrity="sha512-aVKKRRi/Q/Y+4mjoKBsE4x3H+BkegoM/em46NNlCqNTmUYADjBbeNefNxYV7giUp0VxICtqdrbqU7iVaeZNXA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
                        ...
                        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand"  >
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="Detailsbtn" runat="server"  CommandName="edit" CssClass="button text-decoration-none" Text="Edit" CommandArgument='<%#Eval("emp_id") %>' ></asp:LinkButton>
                                   
                                        <asp:LinkButton ID="updatebtn" runat="server" CommandName="update" CssClass="btn btn-info text-light text-decoration-none" Text="Update" Visible="false" CommandArgument='<%#Eval("emp_id") %>' ></asp:LinkButton>
                                    
                                        <asp:LinkButton ID="cancelbtn" runat="server" CommandName="cancel" CssClass="btn btn-danger text-decoration-none" Text="Cancel" Visible="false" CommandArgument='<%#Eval("emp_id") %>'></asp:LinkButton>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
